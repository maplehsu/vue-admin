        ...
        <div class="panel">
          <div class="panel-header">
            <div class="search flex">
              <label class="ivu-label">一级分类名称：</label>
            ...
            return h("div", [
              ...
              h(
                "Button",
                {
                  ...
                  on: {
                    click: () => {
                      this.$router.push({ name: "faqReclassify" });
                      localStorage.setItem("faqId", params.row.Id);
                    }
                  }
                },
                "子分类管理"
      ...
      this.$Modal.confirm({
        ...
        onOk: function() {
          _this.formRef.validate(valid => {
            if (valid) {
              _this.axios.post(_this.api.faqAdd, _this.addData).then(res => {
                if (res.data.Success === true) {
                  _this.update();
                  _this.$Modal.remove();
